	...
	<div class="col col1">
     ...
     <div class="sucursal layout-row" >
         ...
         <div>
         	...
         	<p>Calle 54 No. 210 x 33 Esquina Col. Benito Juárez Norte (atrás de The Home Depot y a un Costado de la Escuela de PostGrado)</p>
         </div>
         <div>
     ...
     <div class="sucursal layout-row" >
         ...
         <div>
         	<img src="/img/pinmap.svg" alt="pinmap" >
         	<p>Calle 68 No. 450-A entre 49 y 51 Col. Centro. Mérida, Yucatán</p>
         </div>
         <div>
         	<img src="/img/horario.svg" alt="horario" >
         	<p>Horario: Lunes a Viernes de 9am a 7 pm / Sabados de 9:00am a 2:00pm</p>
     ...
     <div class="sucursal layout-row" >
         ...
         <div>
         	<img src="/img/pinmap.svg" alt="pinmap" >
         	<p>Av. Uxmal, No. 108 por Chichén Itzá Cancún, Quintana Roo</p>
         </div>
         <div>
         	<img src="/img/horario.svg" alt="horario" >
     ...
     <div class="sucursal layout-row" >
         ...
         <div>
         	<img src="/img/pinmap.svg" alt="pinmap" >
         	<p>CARRETERA PROGRESO KM 19.5 ENTRADA TAMANCHE Mérida, Yucatán</p>
         </div>
         <div>
         	<img src="/img/horario.svg" alt="horario" >
