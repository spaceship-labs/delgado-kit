...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-7fc50430.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-7fc50430.js", assets + "/_app/chunks/vendor-b23f36ca.js", assets + "/_app/chunks/preload-helper-ec9aa979.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-631dd5a7.js", "css": ["assets/pages/__layout.svelte-6e362aef.css"], "js": ["pages/__layout.svelte-631dd5a7.js", "chunks/vendor-b23f36ca.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-15065709.js", "css": [], "js": ["error.svelte-15065709.js", "chunks/vendor-b23f36ca.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-60ad475b.js", "css": ["assets/pages/index.svelte-29ebd2ef.css", "assets/ProductListing-985e7439.css", "assets/ProductSlider-6b54c899.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/index.svelte-60ad475b.js", "chunks/vendor-b23f36ca.js", "chunks/ProductListing-ea9f0c99.js", "chunks/store-81893a8f.js", "chunks/ProductSlider-48a2b48f.js", "chunks/ContactRibbon-1f46a8d2.js"], "styles": [] }, "src/routes/locations.svelte": { "entry": "pages/locations.svelte-1f0c1f8e.js", "css": ["assets/pages/locations.svelte-62266e71.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/locations.svelte-1f0c1f8e.js", "chunks/vendor-b23f36ca.js", "chunks/ContactRibbon-1f46a8d2.js"], "styles": [] }, "src/routes/products.svelte": { "entry": "pages/products.svelte-948efdfc.js", "css": ["assets/pages/products.svelte-f50736d5.css", "assets/ContactRibbon-7c941a1a.css", "assets/BreadCrumbs-b92ebd18.css", "assets/ProductListing-985e7439.css"], "js": ["pages/products.svelte-948efdfc.js", "chunks/vendor-b23f36ca.js", "chunks/ContactRibbon-1f46a8d2.js", "chunks/BreadCrumbs-c674e37c.js", "chunks/ProductListing-ea9f0c99.js", "chunks/store-81893a8f.js"], "styles": [] }, "src/routes/aboutus.svelte": { "entry": "pages/aboutus.svelte-5183099b.js", "css": ["assets/pages/aboutus.svelte-97a28e73.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/aboutus.svelte-5183099b.js", "chunks/vendor-b23f36ca.js", "chunks/ContactRibbon-1f46a8d2.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-7e76c003.js", "css": ["assets/pages/contact.svelte-2f2bd2c7.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/contact.svelte-7e76c003.js", "chunks/vendor-b23f36ca.js", "chunks/ContactRibbon-1f46a8d2.js"], "styles": [] }, "src/routes/product/[handle].svelte": { "entry": "pages/product/[handle].svelte-a219f81d.js", "css": ["assets/pages/product/[handle].svelte-cec64041.css", "assets/BreadCrumbs-b92ebd18.css", "assets/PolicyInfo-221411eb.css", "assets/ProductSlider-6b54c899.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/product/[handle].svelte-a219f81d.js", "chunks/vendor-b23f36ca.js", "chunks/BreadCrumbs-c674e37c.js", "chunks/PolicyInfo-b2622946.js", "chunks/preload-helper-ec9aa979.js", "chunks/ProductSlider-48a2b48f.js", "chunks/ContactRibbon-1f46a8d2.js", "chunks/store-81893a8f.js"], "styles": [] }, "src/routes/cart.svelte": { "entry": "pages/cart.svelte-e7932654.js", "css": ["assets/pages/cart.svelte-f7570d43.css", "assets/BreadCrumbs-b92ebd18.css", "assets/ProductSlider-6b54c899.css", "assets/ContactRibbon-7c941a1a.css", "assets/PolicyInfo-221411eb.css"], "js": ["pages/cart.svelte-e7932654.js", "chunks/vendor-b23f36ca.js", "chunks/BreadCrumbs-c674e37c.js", "chunks/ProductSlider-48a2b48f.js", "chunks/ContactRibbon-1f46a8d2.js", "chunks/PolicyInfo-b2622946.js", "chunks/store-81893a8f.js"], "styles": [] } };
...
var postToShopify = async ({ query, variables }) => {
  ...
  try {
    const result = await fetch("https://manueldelgado.myshopify.com/admin/api/2021-10/graphql.json", {
      ...
      headers: {
        "Content-Type": "application/json",
        "X-Shopify-Access-Token": {}.VITE_SHOPIFY_PASSWORD
      },
      body: JSON.stringify({ query, variables })
    }).then((res) => res.json());
    if (result.errors) {
...
var TopNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="${"svelte-h3d4yo"}"><ul class="${"svelte-h3d4yo"}"><li class="${"svelte-h3d4yo"}"><a href="${"/products"}" class="${"svelte-h3d4yo"}">Productos</a></li>
    ...
    <li class="${"svelte-h3d4yo"}"><a href="${"/contact"}" class="${"svelte-h3d4yo"}">Contacto</a></li></ul>
</nav>`;
});
var css$q = {
...
var ProductCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"svelte-arf72x"}"><a${add_attribute("href", `/product/${product.handle}`, 0)}><header class="${"svelte-arf72x"}"><p class="${"category svelte-arf72x"}">${escape2(product.productType)}</p>
        ${bestDiscount > 0 ? `<p class="${"tag svelte-arf72x"}">${escape2(bestDiscount)}% de desc.</p>` : ``}</header>
    <p class="${"center svelte-arf72x"}"><img${add_attribute("src", product.images.edges[0].node.src, 0)}${add_attribute("alt", product.handle, 0)} class="${"svelte-arf72x"}"></p>
...
var ProductListing = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container svelte-1nzhtjz"}">${title ? `<h3 class="${"strike-header"}"><span>${escape2(title)}</span></h3>` : ``}
	...
	<section class="${"svelte-1nzhtjz"}">${function(__value) {
...
var ProductSummary = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"svelte-mau5ue"}"><header class="${"svelte-mau5ue"}"><p class="${"category svelte-mau5ue"}">Ejecutivas</p>
    ...
    <p class="${"center svelte-mau5ue"}"><img src="${"/img/temp/product" + escape2(product) + ".png"}"${add_attribute("alt", product, 0)} class="${"svelte-mau5ue"}"></p>
...
var ProductSlider = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${"svelte-m5fra7"}"><h3 class="${"svelte-m5fra7"}">${escape2(title)}</h3>
	<div class="${"products svelte-m5fra7"}">${each(products2, (product) => `${validate_component(ProductSummary, "ProductSummary").$$render($$result, { product }, {}, {})}`)}</div>
</section>`;
});
var css$f = {
...
<main class="${"svelte-1dfyygb"}">${validate_component(BreadCrumbs, "BreadCrumbs").$$render($$result, { routes }, {}, {})}
	...
	${validate_component(ProductListing, "ProductListing").$$render($$result, { products: products2 }, {}, {})}</main>
${validate_component(ContactRibbon, "ContactRibbon").$$render($$result, {}, {}, {})}`;
});
...
var css$a = {
  code: "section.svelte-1b0yh1z.svelte-1b0yh1z{padding:0 0 0 40px}.layout-col.svelte-1b0yh1z.svelte-1b0yh1z{-webkit-box-sizing:border-box;box-sizing:border-box;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-line-pack:center;align-content:center;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.layout-row.svelte-1b0yh1z.svelte-1b0yh1z{-webkit-box-sizing:border-box;box-sizing:border-box;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start;-webkit-box-align:start;-ms-flex-align:start;align-items:flex-start;-ms-flex-line-pack:start;align-content:flex-start}.layout-row.svelte-1b0yh1z>.svelte-1b0yh1z,.layout-col.svelte-1b0yh1z>.svelte-1b0yh1z{max-width:100%;-webkit-box-sizing:border-box;box-sizing:border-box}.order-center.svelte-1b0yh1z.svelte-1b0yh1z{-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-ms-flex-line-pack:center;align-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.bannerHolder.svelte-1b0yh1z.svelte-1b0yh1z{background-color:white;width:100%}.bannerHolder.svelte-1b0yh1z>img.svelte-1b0yh1z{width:90%;max-width:500px;height:auto;margin:0 40px}.bannerHolder.svelte-1b0yh1z .bannerRibbon.svelte-1b0yh1z{background-image:linear-gradient(45deg, #396BC2, #688ECC, #00477D);padding:9px 0 3px;min-height:100px;width:100%}.bannerHolder.svelte-1b0yh1z .bannerRibbon div.svelte-1b0yh1z{margin-top:10px;margin-bottom:10px}.bannerHolder.svelte-1b0yh1z .bannerRibbon div img.svelte-1b0yh1z{height:50px;width:50px}.bannerHolder.svelte-1b0yh1z .bannerRibbon h3.svelte-1b0yh1z{font-size:18px;line-height:20px;font-weight:bold;margin:0 20px 0 10px;letter-spacing:1.6px;text-transform:uppercase;color:white}.textHolder.svelte-1b0yh1z.svelte-1b0yh1z{max-width:800px;width:100%}.textHolder.svelte-1b0yh1z h4.svelte-1b0yh1z{font-size:18px;line-height:20px;font-weight:bold;margin-bottom:12px;margin-top:0px;letter-spacing:1.6px;text-transform:uppercase;color:#757575}.textHolder.svelte-1b0yh1z p.svelte-1b0yh1z{font-size:13px;line-height:18px;color:#757575}.col.svelte-1b0yh1z.svelte-1b0yh1z{padding:40px 20px}.col1.svelte-1b0yh1z.svelte-1b0yh1z{width:100%}.col1.svelte-1b0yh1z h3.svelte-1b0yh1z{font-size:22px;line-height:24px;font-weight:bold;margin-bottom:12px;margin-top:0px;letter-spacing:1.6px;text-transform:uppercase;color:#757575;text-align:center}.col2.svelte-1b0yh1z.svelte-1b0yh1z{width:50%}.col3.svelte-1b0yh1z.svelte-1b0yh1z{width:50%}.col4.svelte-1b0yh1z.svelte-1b0yh1z{border-top:2px solid #e4e4e4;width:100%}@media only screen and (max-width: 960px){.col2.svelte-1b0yh1z.svelte-1b0yh1z{width:100%}.col3.svelte-1b0yh1z.svelte-1b0yh1z{width:100%}}@media only screen and (max-width: 500px){.bannerHolder.svelte-1b0yh1z .bannerRibbon div img.svelte-1b0yh1z{height:30px;width:30px}.bannerHolder.svelte-1b0yh1z .bannerRibbon h3.svelte-1b0yh1z{font-size:15px}}",
  map: '{"version":3,"file":"AboutValues.svelte","sources":["AboutValues.svelte"],"sourcesContent":["<section class=\\"layout-col order-center\\">\\r\\n    <div class=\\"bannerHolder layout-col\\">\\r\\n        <img src=\\"/img/md-about.svg\\" alt=\\"about us\\" >\\r\\n        <div class=\\"bannerRibbon layout-row order-center\\">\\r\\n             <div class=\\"layout-row order-center\\">\\r\\n                 <img src=\\"/img/CALIDAD-01.svg\\" alt=\\"calidad\\" >\\r\\n                 <h3>Calidad</h3>\\r\\n             </div>\\r\\n             <div class=\\"layout-row order-center\\">\\r\\n                 <img src=\\"/img/SEGURIDAD-01.svg\\" alt=\\"calidad\\" >\\r\\n                 <h3>Seguridad</h3>\\r\\n             </div>\\r\\n             <div class=\\"layout-row order-center\\">\\r\\n                 <img src=\\"/img/SERVICIO-01.svg\\" alt=\\"calidad\\" >\\r\\n                 <h3>Servicio post-venta</h3>\\r\\n             </div>\\r\\n        </div>\\r\\n    </div>\\r\\n    <div class=\\"textHolder layout-row\\">\\r\\n\\t  <div class=\\"col col1\\">\\r\\n     \\r\\n        <h3>\\"una empresa que entiende los espacios de trabajo como algo m\xE1s que la disposici\xF3n de muebles de oficina\\"</h3>\\r\\n\\r\\n\\t  </div>\\r\\n\\t  <div class=\\"col col2\\">\\r\\n\\t\\t<h4>Filosof\xEDa</h4>\\r\\n        <p>Llegamos al inicio del tercer milenio con la creciente globalizaci\xF3n y competitividad de los negocios. Por eso nos propusimos establecer la filosof\xEDa de nuestra organizaci\xF3n y un plan estrat\xE9gico con el objeto de seguir participando en el mercado regional con un crecimiento continuo y desarrollando juntos la cultura del trabajo.</p>\\r\\n\\t\\t\\r\\n\\t  </div>\\r\\n\\r\\n      <div class=\\"col col3\\">\\r\\n        <h4>Visi\xF3n</h4>\\r\\n        <p>Ser empresa l\xEDder y solida en constante crecimeinto dentro del mercado Nacional, nuestro sello ser\xE1 el compromiso y el trabajo en equipo de directivos y colaboradores, para lograr la m\xE1s alta calidad utilizando tecnolog\xEDa de informaci\xF3n vanguardista a sus servicio.</p>\\r\\n        \\r\\n      </div>\\r\\n\\r\\n      <div class=\\"col col4\\">\\r\\n        <h4>Misi\xF3n</h4>\\r\\n        <p>en DELGADO Y COMPA\xD1IA los directivos y colaboradores somos el capital m\xE1s valioso de la Empresa, y nos comprometemos a cumplir responsablemente nuestra misi\xF3n; trabajando en equipo, propiciando un ambiente agradable, con actitud de servicio y trato personalizado, con el prop\xF3sito dirme de ofrecer a cada persona (cliente) que desempe\xF1a sus labores de trabajo en una oficina: Mobiliario con Cualidades y Dise\xF1os pr\xE1cticos para crear entornos productivos, confortables y est\xE9ticos, Optimizaci\xF3n de espacios e Inversi\xF3n duradera apoyando con productos de reconocido prestigio y de la m\xE1s alta calidad, respaldados con nuestros servicios de garant\xEDa. Con el objeto de lograr su satisfacci\xF3n total; Brind\xE1ndoles \xA1El precio m\xE1s Delgado del Mercado!</p>\\r\\n      </div>\\r\\n    </div>\\r\\n</section>\\r\\n\\r\\n\\r\\n\\r\\n\\r\\n\\r\\n<style>\\r\\n    \\r\\n\\tsection{\\r\\n\\t\\tpadding: 0 0 0 40px;\\r\\n\\t}\\r\\n\\t\\r\\n\\th2{\\r\\n\\t\\tfont-size: 31px;\\r\\n\\t\\tline-height: 34px;\\r\\n\\t\\tfont-weight: bold;\\r\\n\\t\\tmargin-bottom: 46px;\\r\\n\\t\\tmargin-top: 53px;\\r\\n\\t\\tletter-spacing: 1.6px;\\r\\n\\t\\ttext-transform: uppercase;\\r\\n\\t\\tcolor: #757575;\\r\\n\\t}\\r\\n    \\r\\n    .layout-col{\\r\\n       -webkit-box-sizing: border-box;\\r\\n       box-sizing: border-box;\\r\\n       display: -webkit-box;\\r\\n       display: -ms-flexbox;\\r\\n       display: flex;\\r\\n       \\r\\n       -webkit-box-pack: start;\\r\\n       -ms-flex-pack: start;\\r\\n       justify-content: flex-start;\\r\\n\\r\\n       -webkit-box-align: center;\\r\\n       -ms-flex-align: center;\\r\\n       align-items: center;\\r\\n       -ms-flex-line-pack:center;\\r\\n       align-content:center;\\r\\n\\r\\n       -webkit-box-orient: vertical;\\r\\n       -webkit-box-direction: normal;\\r\\n       -ms-flex-direction: column;\\r\\n       flex-direction: column;\\r\\n    }\\r\\n\\t.layout-row{\\r\\n\\t\\t-webkit-box-sizing: border-box;\\r\\n        box-sizing: border-box;\\r\\n        display: -webkit-box;\\r\\n        display: -ms-flexbox;\\r\\n        display: flex;\\r\\n\\r\\n        -webkit-box-orient: horizontal;\\r\\n        -webkit-box-direction: normal;\\r\\n        -ms-flex-direction: row;\\r\\n        flex-direction: row;\\r\\n      \\r\\n        -ms-flex-wrap: wrap;\\r\\n        flex-wrap: wrap;\\r\\n      \\r\\n        -webkit-box-pack: start;\\r\\n        -ms-flex-pack: start;\\r\\n      \\r\\n        justify-content: flex-start;\\r\\n        -webkit-box-align: start;\\r\\n        -ms-flex-align: start;\\r\\n        align-items: flex-start;\\r\\n        -ms-flex-line-pack: start;\\r\\n        align-content: flex-start; \\r\\n\\t}\\r\\n\\t.layout-row > *,\\r\\n\\t.layout-col > *{\\r\\n      max-width: 100%;\\r\\n      -webkit-box-sizing: border-box;\\r\\n      box-sizing: border-box;\\r\\n    }\\r\\n    .order-center{\\r\\n      -webkit-box-pack: center;\\r\\n      -ms-flex-pack: center;\\r\\n      justify-content: center;\\r\\n      -ms-flex-line-pack:center;\\r\\n      align-content:center;\\r\\n      -webkit-box-align: center;\\r\\n      -ms-flex-align: center;\\r\\n      align-items: center;\\r\\n    }\\r\\n\\r\\n    .bannerHolder{\\r\\n        background-color: white;\\r\\n        width: 100%;\\r\\n    }\\r\\n    .bannerHolder > img{\\r\\n        width: 90%;\\r\\n        max-width: 500px;\\r\\n        height: auto;\\r\\n        margin: 0 40px;\\r\\n    }\\r\\n    .bannerHolder .bannerRibbon{\\r\\n        background-image: linear-gradient(45deg, #396BC2, #688ECC, #00477D);\\r\\n        padding: 9px 0 3px;\\r\\n        min-height: 100px;\\r\\n        width: 100%;\\r\\n    }\\r\\n    .bannerHolder .bannerRibbon div{\\r\\n        margin-top: 10px;\\r\\n        margin-bottom: 10px;\\r\\n    }\\r\\n    .bannerHolder .bannerRibbon div img{\\r\\n        height: 50px;\\r\\n        width: 50px;\\r\\n    }\\r\\n    .bannerHolder .bannerRibbon h3{\\r\\n        font-size: 18px;\\r\\n        line-height: 20px;\\r\\n        font-weight: bold;\\r\\n        margin: 0 20px 0 10px;\\r\\n        letter-spacing: 1.6px;\\r\\n        text-transform: uppercase;\\r\\n        color: white;\\r\\n    }\\r\\n\\r\\n    .textHolder{\\r\\n        max-width: 800px;\\r\\n        width: 100%;\\r\\n    }\\r\\n    .textHolder h4{\\r\\n       font-size: 18px;\\r\\n       line-height: 20px;\\r\\n       font-weight: bold;\\r\\n       margin-bottom: 12px;\\r\\n       margin-top: 0px;\\r\\n       letter-spacing: 1.6px;\\r\\n       text-transform: uppercase;\\r\\n       color: #757575;\\r\\n    }\\r\\n    .textHolder p{\\r\\n       font-size: 13px;\\r\\n       line-height: 18px;\\r\\n       color: #757575;\\r\\n    }\\r\\n\\r\\n    .col{\\r\\n        padding: 40px 20px;\\r\\n    }\\r\\n\\t.col1{\\r\\n\\t   width: 100%;\\r\\n\\t}\\r\\n    .col1 h3{\\r\\n       font-size: 22px;\\r\\n       line-height: 24px;\\r\\n       font-weight: bold;\\r\\n       margin-bottom: 12px;\\r\\n       margin-top: 0px;\\r\\n       letter-spacing: 1.6px;\\r\\n       text-transform: uppercase;\\r\\n       color: #757575;\\r\\n       text-align: center;\\r\\n    }\\r\\n    .col2{\\r\\n       width: 50%;\\r\\n    }\\r\\n    .col3{\\r\\n       width: 50%;\\r\\n    }\\r\\n    .col4{\\r\\n       border-top: 2px solid #e4e4e4;\\r\\n       width: 100%;\\r\\n    }\\r\\n\\t\\r\\n\\r\\n\\r\\n    @media only screen and (max-width: 960px){\\r\\n       .col2{\\r\\n          width: 100%;\\r\\n       }\\r\\n       .col3{\\r\\n          width: 100%;\\r\\n       }\\r\\n    }\\r\\n\\t@media only screen and (max-width: 500px){\\r\\n        .bannerHolder .bannerRibbon div img{\\r\\n            height: 30px;\\r\\n            width: 30px;\\r\\n        }\\r\\n        .bannerHolder .bannerRibbon h3{\\r\\n            font-size: 15px;\\r\\n        }\\r\\n\\t}\\r\\n</style>"],"names":[],"mappings":"AAiDC,qCAAO,CAAC,AACP,OAAO,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,AACpB,CAAC,AAaE,yCAAW,CAAC,AACT,kBAAkB,CAAE,UAAU,CAC9B,UAAU,CAAE,UAAU,CACtB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CAEb,gBAAgB,CAAE,KAAK,CACvB,aAAa,CAAE,KAAK,CACpB,eAAe,CAAE,UAAU,CAE3B,iBAAiB,CAAE,MAAM,CACzB,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,mBAAmB,MAAM,CACzB,cAAc,MAAM,CAEpB,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CAC7B,kBAAkB,CAAE,MAAM,CAC1B,cAAc,CAAE,MAAM,AACzB,CAAC,AACJ,yCAAW,CAAC,AACX,kBAAkB,CAAE,UAAU,CACxB,UAAU,CAAE,UAAU,CACtB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CAEb,kBAAkB,CAAE,UAAU,CAC9B,qBAAqB,CAAE,MAAM,CAC7B,kBAAkB,CAAE,GAAG,CACvB,cAAc,CAAE,GAAG,CAEnB,aAAa,CAAE,IAAI,CACnB,SAAS,CAAE,IAAI,CAEf,gBAAgB,CAAE,KAAK,CACvB,aAAa,CAAE,KAAK,CAEpB,eAAe,CAAE,UAAU,CAC3B,iBAAiB,CAAE,KAAK,CACxB,cAAc,CAAE,KAAK,CACrB,WAAW,CAAE,UAAU,CACvB,kBAAkB,CAAE,KAAK,CACzB,aAAa,CAAE,UAAU,AAChC,CAAC,AACD,0BAAW,CAAG,eAAC,CACf,0BAAW,CAAG,eAAC,CAAC,AACX,SAAS,CAAE,IAAI,CACf,kBAAkB,CAAE,UAAU,CAC9B,UAAU,CAAE,UAAU,AACxB,CAAC,AACD,2CAAa,CAAC,AACZ,gBAAgB,CAAE,MAAM,CACxB,aAAa,CAAE,MAAM,CACrB,eAAe,CAAE,MAAM,CACvB,mBAAmB,MAAM,CACzB,cAAc,MAAM,CACpB,iBAAiB,CAAE,MAAM,CACzB,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,2CAAa,CAAC,AACV,gBAAgB,CAAE,KAAK,CACvB,KAAK,CAAE,IAAI,AACf,CAAC,AACD,4BAAa,CAAG,kBAAG,CAAC,AAChB,KAAK,CAAE,GAAG,CACV,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,CAAC,CAAC,IAAI,AAClB,CAAC,AACD,4BAAa,CAAC,4BAAa,CAAC,AACxB,gBAAgB,CAAE,gBAAgB,KAAK,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CAAC,OAAO,CAAC,CACnE,OAAO,CAAE,GAAG,CAAC,CAAC,CAAC,GAAG,CAClB,UAAU,CAAE,KAAK,CACjB,KAAK,CAAE,IAAI,AACf,CAAC,AACD,4BAAa,CAAC,aAAa,CAAC,kBAAG,CAAC,AAC5B,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,IAAI,AACvB,CAAC,AACD,4BAAa,CAAC,aAAa,CAAC,GAAG,CAAC,kBAAG,CAAC,AAChC,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,AACf,CAAC,AACD,4BAAa,CAAC,aAAa,CAAC,iBAAE,CAAC,AAC3B,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,CACrB,cAAc,CAAE,KAAK,CACrB,cAAc,CAAE,SAAS,CACzB,KAAK,CAAE,KAAK,AAChB,CAAC,AAED,yCAAW,CAAC,AACR,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,IAAI,AACf,CAAC,AACD,0BAAW,CAAC,iBAAE,CAAC,AACZ,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,IAAI,CACjB,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,GAAG,CACf,cAAc,CAAE,KAAK,CACrB,cAAc,CAAE,SAAS,CACzB,KAAK,CAAE,OAAO,AACjB,CAAC,AACD,0BAAW,CAAC,gBAAC,CAAC,AACX,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,KAAK,CAAE,OAAO,AACjB,CAAC,AAED,kCAAI,CAAC,AACD,OAAO,CAAE,IAAI,CAAC,IAAI,AACtB,CAAC,AACJ,mCAAK,CAAC,AACH,KAAK,CAAE,IAAI,AACd,CAAC,AACE,oBAAK,CAAC,iBAAE,CAAC,AACN,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,WAAW,CAAE,IAAI,CACjB,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,GAAG,CACf,cAAc,CAAE,KAAK,CACrB,cAAc,CAAE,SAAS,CACzB,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,MAAM,AACrB,CAAC,AACD,mCAAK,CAAC,AACH,KAAK,CAAE,GAAG,AACb,CAAC,AACD,mCAAK,CAAC,AACH,KAAK,CAAE,GAAG,AACb,CAAC,AACD,mCAAK,CAAC,AACH,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,OAAO,CAC7B,KAAK,CAAE,IAAI,AACd,CAAC,AAID,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,AACvC,mCAAK,CAAC,AACH,KAAK,CAAE,IAAI,AACd,CAAC,AACD,mCAAK,CAAC,AACH,KAAK,CAAE,IAAI,AACd,CAAC,AACJ,CAAC,AACJ,OAAO,IAAI,CAAC,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,CAAC,AACnC,4BAAa,CAAC,aAAa,CAAC,GAAG,CAAC,kBAAG,CAAC,AAChC,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,AACf,CAAC,AACD,4BAAa,CAAC,aAAa,CAAC,iBAAE,CAAC,AAC3B,SAAS,CAAE,IAAI,AACnB,CAAC,AACR,CAAC"}'
};
var AboutValues = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$a);
  return `<section class="${"layout-col order-center svelte-1b0yh1z"}"><div class="${"bannerHolder layout-col svelte-1b0yh1z"}"><img src="${"/img/md-about.svg"}" alt="${"about us"}" class="${"svelte-1b0yh1z"}">
        <div class="${"bannerRibbon layout-row order-center svelte-1b0yh1z"}"><div class="${"layout-row order-center svelte-1b0yh1z"}"><img src="${"/img/CALIDAD-01.svg"}" alt="${"calidad"}" class="${"svelte-1b0yh1z"}">
                 <h3 class="${"svelte-1b0yh1z"}">Calidad</h3></div>
             <div class="${"layout-row order-center svelte-1b0yh1z"}"><img src="${"/img/SEGURIDAD-01.svg"}" alt="${"calidad"}" class="${"svelte-1b0yh1z"}">
                 <h3 class="${"svelte-1b0yh1z"}">Seguridad</h3></div>
             <div class="${"layout-row order-center svelte-1b0yh1z"}"><img src="${"/img/SERVICIO-01.svg"}" alt="${"calidad"}" class="${"svelte-1b0yh1z"}">
                 <h3 class="${"svelte-1b0yh1z"}">Servicio post-venta</h3></div></div></div>
    <div class="${"textHolder layout-row svelte-1b0yh1z"}"><div class="${"col col1 svelte-1b0yh1z"}"><h3 class="${"svelte-1b0yh1z"}">&quot;una empresa que entiende los espacios de trabajo como algo m\xE1s que la disposici\xF3n de muebles de oficina&quot;</h3></div>
	  <div class="${"col col2 svelte-1b0yh1z"}"><h4 class="${"svelte-1b0yh1z"}">Filosof\xEDa</h4>
        <p class="${"svelte-1b0yh1z"}">Llegamos al inicio del tercer milenio con la creciente globalizaci\xF3n y competitividad de los negocios. Por eso nos propusimos establecer la filosof\xEDa de nuestra organizaci\xF3n y un plan estrat\xE9gico con el objeto de seguir participando en el mercado regional con un crecimiento continuo y desarrollando juntos la cultura del trabajo.</p></div>

      <div class="${"col col3 svelte-1b0yh1z"}"><h4 class="${"svelte-1b0yh1z"}">Visi\xF3n</h4>
        <p class="${"svelte-1b0yh1z"}">Ser empresa l\xEDder y solida en constante crecimeinto dentro del mercado Nacional, nuestro sello ser\xE1 el compromiso y el trabajo en equipo de directivos y colaboradores, para lograr la m\xE1s alta calidad utilizando tecnolog\xEDa de informaci\xF3n vanguardista a sus servicio.</p></div>

      <div class="${"col col4 svelte-1b0yh1z"}"><h4 class="${"svelte-1b0yh1z"}">Misi\xF3n</h4>
        <p class="${"svelte-1b0yh1z"}">en DELGADO Y COMPA\xD1IA los directivos y colaboradores somos el capital m\xE1s valioso de la Empresa, y nos comprometemos a cumplir responsablemente nuestra misi\xF3n; trabajando en equipo, propiciando un ambiente agradable, con actitud de servicio y trato personalizado, con el prop\xF3sito dirme de ofrecer a cada persona (cliente) que desempe\xF1a sus labores de trabajo en una oficina: Mobiliario con Cualidades y Dise\xF1os pr\xE1cticos para crear entornos productivos, confortables y est\xE9ticos, Optimizaci\xF3n de espacios e Inversi\xF3n duradera apoyando con productos de reconocido prestigio y de la m\xE1s alta calidad, respaldados con nuestros servicios de garant\xEDa. Con el objeto de lograr su satisfacci\xF3n total; Brind\xE1ndoles \xA1El precio m\xE1s Delgado del Mercado!</p></div></div>
</section>`;
});
var css$9 = {
  code: "main.svelte-rgceyd{max-width:1440px;margin:0px auto}",
