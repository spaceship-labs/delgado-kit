...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-60a6f2d5.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-60a6f2d5.js", assets + "/_app/chunks/vendor-2b76f189.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-cdb6aa40.js", "css": ["assets/pages/__layout.svelte-6e362aef.css"], "js": ["pages/__layout.svelte-cdb6aa40.js", "chunks/vendor-2b76f189.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-600d82a9.js", "css": [], "js": ["error.svelte-600d82a9.js", "chunks/vendor-2b76f189.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-079ea88b.js", "css": ["assets/pages/index.svelte-29ebd2ef.css", "assets/ProductListing-985e7439.css", "assets/ProductSlider-6b54c899.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/index.svelte-079ea88b.js", "chunks/vendor-2b76f189.js", "chunks/ProductListing-d57dbb82.js", "chunks/store-c201f4c4.js", "chunks/ProductSlider-91a01a61.js", "chunks/ContactRibbon-165e7503.js"], "styles": [] }, "src/routes/products.svelte": { "entry": "pages/products.svelte-cdc7ef9b.js", "css": ["assets/pages/products.svelte-f50736d5.css", "assets/ContactRibbon-7c941a1a.css", "assets/BreadCrumbs-b92ebd18.css", "assets/ProductListing-985e7439.css"], "js": ["pages/products.svelte-cdc7ef9b.js", "chunks/vendor-2b76f189.js", "chunks/ContactRibbon-165e7503.js", "chunks/BreadCrumbs-1c06fcde.js", "chunks/ProductListing-d57dbb82.js", "chunks/store-c201f4c4.js"], "styles": [] }, "src/routes/contact.svelte": { "entry": "pages/contact.svelte-4be12292.js", "css": ["assets/pages/contact.svelte-2f2bd2c7.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/contact.svelte-4be12292.js", "chunks/vendor-2b76f189.js", "chunks/ContactRibbon-165e7503.js"], "styles": [] }, "src/routes/product/[handle].svelte": { "entry": "pages/product/[handle].svelte-21a26583.js", "css": ["assets/pages/product.svelte-50add950.css", "assets/BreadCrumbs-b92ebd18.css", "assets/ProductDetail-bc049ff5.css", "assets/PolicyInfo-221411eb.css", "assets/ProductSlider-6b54c899.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/product/[handle].svelte-21a26583.js", "chunks/vendor-2b76f189.js", "chunks/BreadCrumbs-1c06fcde.js", "chunks/ProductDetail-3a235c90.js", "chunks/PolicyInfo-e7009d7f.js", "chunks/ProductSlider-91a01a61.js", "chunks/ContactRibbon-165e7503.js", "chunks/store-c201f4c4.js"], "styles": [] }, "src/routes/product.svelte": { "entry": "pages/product.svelte-1364e04f.js", "css": ["assets/pages/product.svelte-50add950.css", "assets/BreadCrumbs-b92ebd18.css", "assets/ProductDetail-bc049ff5.css", "assets/PolicyInfo-221411eb.css", "assets/ProductSlider-6b54c899.css", "assets/ContactRibbon-7c941a1a.css"], "js": ["pages/product.svelte-1364e04f.js", "chunks/vendor-2b76f189.js", "chunks/BreadCrumbs-1c06fcde.js", "chunks/ProductDetail-3a235c90.js", "chunks/PolicyInfo-e7009d7f.js", "chunks/ProductSlider-91a01a61.js", "chunks/ContactRibbon-165e7503.js"], "styles": [] }, "src/routes/cart.svelte": { "entry": "pages/cart.svelte-cc14c58a.js", "css": ["assets/pages/cart.svelte-f37fb943.css", "assets/BreadCrumbs-b92ebd18.css", "assets/ProductSlider-6b54c899.css", "assets/ContactRibbon-7c941a1a.css", "assets/PolicyInfo-221411eb.css"], "js": ["pages/cart.svelte-cc14c58a.js", "chunks/vendor-2b76f189.js", "chunks/BreadCrumbs-1c06fcde.js", "chunks/ProductSlider-91a01a61.js", "chunks/ContactRibbon-165e7503.js", "chunks/PolicyInfo-e7009d7f.js"], "styles": [] } };
...
var ProductCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let productVariants = product2.variants.edges.map((v) => v.node);
  let currCode = productVariants[0].priceV2.currencyCode;
  let bestDiscount = 0;
  for (let variant of productVariants) {
    if (variant.compareAtPrice != null) {
  ...
  return `<article class="${"svelte-arf72x"}"><a${add_attribute("href", `/product/${product2.handle}`, 0)}><header class="${"svelte-arf72x"}"><p class="${"category svelte-arf72x"}">${escape2(product2.productType)}</p>
        ${bestDiscount > 0 ? `<p class="${"tag svelte-arf72x"}">${escape2(bestDiscount)}% de desc.</p>` : ``}</header>
    <p class="${"center svelte-arf72x"}"><img${add_attribute("src", product2.images.edges[0].node.src, 0)}${add_attribute("alt", product2.handle, 0)} class="${"svelte-arf72x"}"></p>
    <h4 class="${"svelte-arf72x"}">${escape2(product2.title)}</h4>
    
    ${productVariants.length < 1 && productVariants[0].sku != null ? `<h5 class="${"svelte-arf72x"}">SKU: ${escape2(productVariants[0].sku)}</h5>` : ``}
    <p class="${"price svelte-arf72x"}">${productVariants.length > 1 ? `<strong>${escape2(product2.priceRange.minVariantPrice)} ${escape2(currCode)} - ${escape2(product2.priceRange.maxVariantPrice)} ${escape2(currCode)}</strong>` : `<strong>${escape2(productVariants[0].priceV2.amount)} ${escape2(currCode)}</strong>
...
var ProductListing = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container svelte-1nzhtjz"}">${title ? `<h3 class="${"strike-header"}"><span>${escape2(title)}</span></h3>` : ``}
    ...
    return function(coll2) {
      return ` 
		  ${each(coll2.products.edges, (product2) => `${validate_component(ProductCard, "ProductCard").$$render($$result, { product: product2.node }, {}, {})}`)}
		`;
    }(__value);
  }(coll)}</section>
...
var ProductSlider = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${"svelte-m5fra7"}"><h3 class="${"svelte-m5fra7"}">${escape2(title)}</h3>
	<div class="${"products svelte-m5fra7"}">${each(products2, (product2) => `${validate_component(ProductSummary, "ProductSummary").$$render($$result, { product: product2 }, {}, {})}`)}</div>
</section>`;
});
var css$e = {
...
var ProductDetail = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="${"svelte-1d56od4"}"><section class="${"svelte-1d56od4"}"><h1 class="${"svelte-1d56od4"}">${escape2(product2.title)}</h1>
        ...
        <p class="${"price svelte-1d56od4"}">${productVariants.length > 1 ? `<strong>${escape2(product2.priceRange.minVariantPrice)} ${escape2(currCode)} - ${escape2(product2.priceRange.maxVariantPrice)} ${escape2(currCode)}</strong>` : `<strong>${escape2(productVariants[0].priceV2.amount)} ${escape2(currCode)}</strong>
              ${productVariants[0].compareAtPrice != null ? `<span class="${"original-price"}">${escape2(productVariants[0].compareAtPrice)} ${escape2(currCode)}</span>` : ``}`}</p>
		...
		<div class="${"description svelte-1d56od4"}">${escape2(product2.description)}
			<p class="${"note svelte-1d56od4"}">Los precios no incluyen IVA</p></div></section>
	<section class="${"svelte-1d56od4"}">${validate_component(ProductGallery, "ProductGallery").$$render($$result, { images: product2.images.edges }, {}, {})}</section>
...
var CartItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"svelte-2bm9r"}"><h3 class="${"svelte-2bm9r"}">${escape2(product2.name)}</h3>
	<section class="${"svelte-2bm9r"}"><img${add_attribute("src", product2.img, 0)} alt="${"thumbnail"}" class="${"svelte-2bm9r"}">
		<div class="${"details svelte-2bm9r"}"><p class="${"svelte-2bm9r"}">SKU: ${escape2(product2.sku)}</p>
			<p class="${"svelte-2bm9r"}">${escape2(product2.variant)}</p></div>
...
<main class="${"svelte-dfuyl0"}"><section class="${"svelte-dfuyl0"}">${each(products2, (product2) => `${validate_component(CartItem, "CartItem").$$render($$result, { product: product2 }, {}, {})}`)}
